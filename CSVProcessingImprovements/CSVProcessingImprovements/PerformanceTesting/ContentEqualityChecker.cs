...
namespace CSVProcessingImprovements.PerformanceTesting
{

    public class ContentEqualityChecker
    {
        public static bool IsEqual(
            ITableDataBuilder leftTableDataBuilder,
            ITableDataBuilder rightTableDataBuilder,
            CsvData csvData)
        {
            var leftData = leftTableDataBuilder.Build(csvData);
            var rightData = rightTableDataBuilder.Build(csvData);
