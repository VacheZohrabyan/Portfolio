...
{
    public string ExpectedBaseAddress = "https://swapi.dev/";
    public string ExpectedRequestUri = "api/planets";
    ...
    public Task<string> Read(string baseAddress, string requestUri)
    {
        ...
        else if (requestUri != ExpectedRequestUri)
        {
            throw new ArgumentException($"Request Uri can only be {ExpectedRequestUri}");
        }
